 ...
 * desc :
 */
public class NavigationListBean  extends SectionEntity<NavigationListBean.ArticlesBean> {
    ...
    public NavigationListBean(boolean isHeader, String header) {
        super(isHeader, header);
    }

    public NavigationListBean(ArticlesBean articlesBean) {
        super(articlesBean);
    }
    ...
    public static class ArticlesBean extends SectionEntity {
        /**
         * apkLink :
         * author : 小编
         * chapterId : 272
        ...
        public ArticlesBean(boolean isHeader, String header) {
            super(isHeader, header);
        }

        public ArticlesBean(Object o) {
            super(o);
        }
