...
import com.lgf.mywanandroid.lgf.AppManager;
...
import com.lgf.mywanandroid.lgf.widgets.WaitPorgressDialog;
...
public abstract class BaseCompatActivity  extends SupportActivity {
    ...
    private void init(Bundle savedInstanceState) {
        //setTheme(ThemeUtils.themeArr[SpUtils.getThemeIndex(this)][SpUtils.getNightModel(this) ? 1 : 0]);//设置主题
        //setTheme(R.style.AppBaseTheme);
        setContentView(getLayoutId());//设置布局
        ButterKnife.bind(this);
        StatusBarUtils.setTransparent(this);//设置状态栏颜色
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);//设置屏幕方向
        initData();
        initView(savedInstanceState);
        AppManager.getAppManager().addActivity(this);//管理activity
    }
